				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input class="form-control" type="text" id="create-IdeaGroup" list="create-IdeaGroup-list">
								<datalist id="create-IdeaGroup-list">
									<option></option>
							...
							<div class="col-sm-10" style="width: 300px;">
								<input class="form-control" type="text" id="create-IdeaState" list="create-IdeaState-list">
								<datalist id="create-IdeaState-list">
									<option></option>
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input class="form-control" type="text" id="create-IdeaSource" list="create-IdeaSource-list">
								<datalist id="create-IdeaSource-list">
									<option></option>
				...
				<div class="modal-body">
					<form class="form-horizontal" id="ideaEditForm" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input class="form-control" type="text" id="edit-IdeaGroup" list="edit-IdeaGroup-list">
								<datalist id="edit-IdeaGroup-list">
									<option></option>
									<c:forEach items="${IdeaGroup}" var="group">
										<option value="${group.value}">${group.text}</option>
									</c:forEach>
							...
							<div class="col-sm-10" style="width: 300px;">
								<input class="form-control" type="text" id="edit-IdeaState" list="edit-IdeaState-list">
								<datalist id="edit-IdeaState-list">
									<option></option>
									<c:forEach items="${IdeaState}" var="state">
										<option value="${state.value}">${state.text}</option>
									</c:forEach>
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input class="form-control" type="text" id="edit-IdeaSource" list="edit-IdeaSource-list">
								<datalist id="edit-IdeaSource-list">
									<option></option>
									<c:forEach items="${IdeaSource}" var="source">
										<option value="${source.value}">${source.text}</option>
									</c:forEach>
	...
	<div>
		<div style="position: relative; left: 10px; top: -10px;">
			<div class="page-header">
				<h3 style="position: relative; left: 30%;
			               font-size: 35px;
			               text-shadow: 0 0px 30px rgba(0, 0, 0, 0.2);">Idea List
				<small>&nbsp;在这里您可以记录您的想法</small></h3>
			</div>
		</div>
	</div>
				  ...
				  <div class="form-group">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input  class="form-control hidden" type="text" id="search-IdeaLoginAct" value="${user.loginAct}">
						</div>
					</div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      <div class="input-group-addon">分组</div>
						<input class="form-control" type="text" id="search-IdeaGroup" list="search-IdeaGroup-list">
						<datalist id="search-IdeaGroup-list">
							<option></option>
							<c:forEach items="${IdeaGroup}" var="group">
								<option value="${group.value}">${group.text}</option>
							</c:forEach>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      <div class="input-group-addon">状态</div>
						<input class="form-control" type="text" id="search-IdeaState" list="search-IdeaState-list">
						<datalist id="search-IdeaState-list">
							<option></option>
							<c:forEach items="${IdeaState}" var="state">
								<option value="${state.value}">${state.text}</option>
							</c:forEach>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      <div class="input-group-addon">来源</div>
						<input class="form-control" type="text" id="search-IdeaSource" list="search-IdeaSource-list">
						<datalist id="search-IdeaSource-list">
							<option></option>
							<c:forEach items="${IdeaSource}" var="source">
								<option value="${source.value}">${source.text}</option>
							</c:forEach>
		...
		function pageList(pageNo,pageSize){
			...
			$.ajax({
				...
				success :function (data){
					...
					$('tr[name="非常伟大的想法"]').addClass("bg-primary");
					$('tr[name="有点意思的想法"]').addClass("bg-info");
