...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    ...
						    <span id="searchSpan" class="glyphicon glyphicon-search form-control-feedback"></span>
						  </div>
						</form>
					</div>
	...
	<div style="position: relative; left: 15%; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 50%;">
			<button type="button" class="btn btn-warning" onclick="window.location.href='workbench/idea/convert.jsp?ideaId=${idea.id}&name=${idea.name}&loginAct=${idea.loginAct}';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
...
<%--		<div style="position: relative; left: 40px; height: 30px; top: 30px;">
	...
	<!-- 日历计划 -->
	<div>
		<div style="position: relative; top: 60px; left: 15%;">
			<div class="page-header">
				<h4>日历计划</h4>
			</div>
