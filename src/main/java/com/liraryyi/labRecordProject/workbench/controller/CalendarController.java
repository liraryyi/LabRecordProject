...
public class CalendarController {
    ...
    public void deleteCalendarByIds(HttpServletRequest request,HttpServletResponse response){

        String[] ids = request.getParameterValues("id");

        boolean success = calendarService.deleteCalendarByIds(ids);
    ...
    @RequestMapping(value = "/calendar/deleteCalendarById.do")
    public void deleteCalendarById(HttpServletRequest request,HttpServletResponse response){

        String id = request.getParameter("id");

        boolean success = calendarService.deleteCalendarById(id);
